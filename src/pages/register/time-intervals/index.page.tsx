...
const timeIntervalsFormSchema = z.object({
  intervals: z
    ...
    .length(7)
    .transform((intervals) => intervals.filter((interval) => interval.enabled)) // Essa parte serve para enviar o Post só com os checkbox selecionados, no caso enabled
    .refine((intervals) => intervals.length > 0, {
      message: 'Você precisa selecionar pelo menos um dia da semana!',
    }) // Essa parte serve para validar se pelo menos 1 dia da semana foi selecionado, não podemos usar o min(), por isso do refine()
    .transform((intervals) => {
